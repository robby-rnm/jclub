...
export default function Login() {
    ...
    const handleGoogleLogin = () => {
        ...
        window.location.href = 'https://jclubadmin.gsteknologi.com/api/oauth/login';
    };
    ...
    return (
        <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            <div className="card auth-form" style={{ width: '100%', maxWidth: '400px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '1rem', color: 'var(--text-dim)' }}>
                    — or —
                </div>
                ...
                <form onSubmit={handleEmailLogin}>
                    <div style={{ marginBottom: '1rem' }}>
                        ...
                        <input
                            ...
                            placeholder="admin@jclub.com"
                            required
                        />
                    </div>
                    <div style={{ marginBottom: '1.5rem' }}>
                        <label style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--text)' }}>Password</label>
                        <input
                            type="password"
                            className="input-field"
                            value={password}
                ...
                <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.75rem', color: 'var(--text-dim)' }}>
                    Secure Access Only • Admin Panel
                </div>
            </div>
        </div>
    );
