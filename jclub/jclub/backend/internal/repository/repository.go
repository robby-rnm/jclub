...
type Repository interface {
	...
	// Sport & Position CRUD
	CreateSport(sport *models.Sport) error
	DeleteSport(id string) error
	CreatePosition(position *models.SportPosition) error
...
func (r *repository) CreateSport(sport *models.Sport) error {
	return r.db.Create(sport).Error
}

func (r *repository) DeleteSport(id string) error {
	// Delete positions first
	r.db.Where("sport_id = ?", id).Delete(&models.SportPosition{})
	return r.db.Delete(&models.Sport{}, "id = ?", id).Error
}

func (r *repository) CreatePosition(position *models.SportPosition) error {
...
func (r *repository) GetUserBookings(userID string) ([]models.Booking, error) {
	var bookings []models.Booking
